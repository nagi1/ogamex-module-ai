...
**Not started: Package 5 (external drivers) and Package 6 (cooperative PvE).** Package 5 is scoped in [external drivers](details/specs/external-drivers.md). Package 6 waits on Packages 1–5 being complete, the completion gate closing and Package 4 being signed — acceptance criteria met with evidence, the 10-account pilot report reviewed and its findings accepted, and that acceptance recorded in [details/DECISIONS.md](details/DECISIONS.md).
