...
| 3C — native affect | **In progress:** native `AffectEngine` performs bounded, persona-sensitive aid, threat and harm appraisal; persisted state decays deterministically. Emotional episodes and disabled enrichment remain. | Same evidence differs meaningfully by persona; state/decay/restart remain deterministic. |
