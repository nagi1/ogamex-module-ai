...
| 3D — social protocols | **In progress:** explicit typed greetings, thanks, help/resource, trade, ceasefire, apology, warning, cooperation and compensation exchanges retain bounded depth, source, exact terms, response state and expiry. Authored zero-LLM variants queue through the sealed host delivery ledger. Unsupported game capabilities decline or clarify; accepted compensation creates an exact outstanding counterparty commitment and does not fulfill it. | Accept/reject/counter/clarify, betrayal/apology, outstanding obligations, a real bounded AI-to-AI delivery lifecycle, locale-aware seeded variants, repetition cooldown and one-delivery receipt proof. |
