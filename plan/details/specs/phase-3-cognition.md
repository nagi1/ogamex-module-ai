...
| 3G — context and usage | **In progress:** native fact recall is owner-scoped, current-validity/redaction-aware and source/evidence-provenance-preserving; deterministic bounded context selection and atomic daily universe/account/conversation reservation ledgers are implemented, and usage settles once without releasing the counted attempt. Protected-content overflow policy remains. | Scoped/provenance-preserving context; protected-content overflow and concurrent cap tests. No provider needed. |
