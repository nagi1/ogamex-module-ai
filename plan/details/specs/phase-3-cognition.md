...
5. **Completed — final pre-3H acceptance pass.** The complete native social, experience, delivery, recall/context and budget matrix passes with provider-off behavior: Pint, Rector dry-run, module PHPStan, PAO Pest (138 tests, 550 assertions), exact 100% PCOV and TIA. Do not begin `LanguageGateway`, provider configuration, SDK installation or LLM tests until a separately authorized optional-provider phase.
