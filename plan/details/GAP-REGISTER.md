...
**Read the two rows against this measurement, not against their size.** A perception build is ~439 queries and 19.7–23.1 s, with ~95 % of the wall clock inside query calls; W10-1 is 105 of those queries and W10-2 is the rest, so **closing W10-1 alone leaves ~15 s** and the two rows have to land together to matter. Two further cautions, both measured:
